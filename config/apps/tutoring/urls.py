...
urlpatterns = [
    ...
    path(
        "resources/<int:registration_id>/commission-payment/reissue/",
        CommissionPaymentReissueView.as_view(),
        name="commission-payment-reissue",
    ),
